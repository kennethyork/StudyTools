...
| **Bible Dictionary** (`apps/dictionary/`) | Six sources together: Easton's (1897), Smith's (1863) and Hastings' (1909) on the Bible's people, places and subjects; Hitchcock's Bible Names (1869) for what a name means; Webster's 1828 Dictionary abridged to the words the King James Version uses — the one that defines *lasciviousness*, or the King James sense of *conversation* — and, where those leave a gap a reader meets often, a note written for this site quoting the verse it comes from. A word the King James writes in an older form (*aboundeth*, *pouredst*, *oxen*) is found under its headword. Scripture citations link straight into the Verse Matrix. |
...
data/dictionary/         Easton, Smith, Hastings, Hitchcock and Webster's 1828 entries
...
node scripts/check-dictionary.js      # re-checks the five dictionaries, merged and abridged
