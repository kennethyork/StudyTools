...
| **Bible Dictionary** (`apps/dictionary/`) | Five public-domain dictionaries together: Easton's (1897), Smith's (1863) and Hastings' (1909) on the Bible's people, places and subjects; Hitchcock's Bible Names (1869) for what a name means; and Webster's 1828 Dictionary abridged to the words the King James Version uses — the one that defines *lasciviousness*, or the King James sense of *conversation*. Scripture citations link straight into the Verse Matrix. |
